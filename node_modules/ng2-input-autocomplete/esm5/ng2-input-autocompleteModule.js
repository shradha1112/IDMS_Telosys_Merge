...
var AutocompleteComponent = /** @class */ (function () {
    ...
    AutocompleteComponent.prototype.enterText = function (event) {
        var /** @type {?} */ total = this.candidates.length;
    ...
    AutocompleteComponent.prototype.filterItems = function (search) {
        var /** @type {?} */ field = this.sourceField;
        var /** @type {?} */ filterItem = this.filterItem;
        if (this.items) {
    ...
    AutocompleteComponent.prototype.buildLabels = function () {
        var /** @type {?} */ field = this.sourceField;
        var /** @type {?} */ getFieldValue = this.getFieldValue;
...
var AutocompleteDirective = /** @class */ (function () {
    ...
    AutocompleteDirective.prototype.createDiv = function () {
        var /** @type {?} */ element = document.createElement('div');
    ...
    AutocompleteDirective.prototype.createAutocomplete = function () {
        var /** @type {?} */ factory = this.resolver.resolveComponentFactory(AutocompleteComponent);
        ...
        if (this.componentRef) {
            var /** @type {?} */ rect = this.thisElement.getBoundingClientRect();
            var /** @type {?} */ style = this.autocompleteElement.style;
