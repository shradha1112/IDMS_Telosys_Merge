...
public abstract class WorkflowMapper {
	...
	public abstract WorkflowDTO entityToWorkflowDTO(Workflow entity);

	@Mapping(target = "activeFlag", expression = "java(FormatConverterUtils.convertBooleantoActiveFlag(dto.getActiveFlag()))")
	public abstract Workflow workflowToEntity(WorkflowDTO dto);

	public abstract List<WorkflowDTO> entityListToworkflowDTOList(List<Workflow> entities);
}
