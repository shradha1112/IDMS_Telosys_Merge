...
private static final String ADMIN = "ROLE_ADMIN";
	...
	public IDMSUserDTO(@JsonProperty("staffId")Long staffId, @JsonProperty("loginId") String loginId,@JsonProperty("loginKey") String loginKey) {
		super();
		this.staffId = staffId;
		this.loginId = loginId;
		this.loginKey = loginKey;
